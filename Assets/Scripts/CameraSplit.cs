...
public class TestCam : MonoBehaviour {
	...
	void SetCameraSize() {
		...
		float width = Mathf.Abs(player1.position.x - player2.position.x + xOffset) * 0.5f;
		float height = Mathf.Abs(player1.position.y - player2.position.y + yOffset2) * 0.5f;
